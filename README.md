...
This repository is a lightweight copy of [folke/snacks.nvim](https://github.com/folke/snacks.nvim) with the test files and git history removed to minimize disk usage.

## What's Different?

- **No test folder**: Removes ~20MB of test files
- **Minimal git history**: Fork does not contain git history
- **Same functionality**: All snacks.nvim features work identically

This slims down your `nvim-data` directory from ~30MB to just a few MB.

## Why This Exists

If you're using [lazy.nvim](https://github.com/folke/lazy.nvim), there's [no built-in way to force shallow clones](https://github.com/folke/lazy.nvim/issues/406) for individual plugins.
...
This repo syncs with upstream snacks.nvim regularly, pulling only the essential changes.
